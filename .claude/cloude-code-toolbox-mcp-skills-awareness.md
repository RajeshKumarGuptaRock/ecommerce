...
_Generated: 2026-08-18T14:15:35.728Z_
...
Workspace `mcp.json` _(folder: eCommerce-Web-Admin)_

- **/var/www/html/WorkingProject/eCommerce-Web-Admin/.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **/home/rajesh/.claude.json** — _File exists — no servers defined_
